...
function Projects() {
    ...
    const scale = useTransform(scrollYProgress, [0.5, 0.6], [0.1, 1]);
    const scalet = useTransform(scrollYProgress, [0.5, 0.7], [0.1, 1]);
    const scaleh = useTransform(scrollYProgress, [0.5, 0.8], [0.1, 1]);
